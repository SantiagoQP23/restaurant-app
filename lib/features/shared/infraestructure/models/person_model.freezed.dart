...
class _$PersonModelImpl extends _PersonModel {
  ...
  @override
  String toString() {
    return 'PersonModel(id: $id, firstName: $firstName, lastName: $lastName, email: $email, numPhone: $numPhone, identification: $identification)';
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.numPhone, numPhone) ||
                other.numPhone == numPhone) &&
  ...
  int get hashCode => Object.hash(
      runtimeType, id, firstName, lastName, email, numPhone, identification);
